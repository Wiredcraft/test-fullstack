...
export class AddTalksAndVotes1645201465621 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "vote" ADD CONSTRAINT "FK_8031ceec97b8f3dd743f14198b9" FOREIGN KEY ("talkId") REFERENCES "talk"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "talk" ADD CONSTRAINT "FK_39e08499e59d1c7c0adad1cbb9f" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "talk" DROP CONSTRAINT "FK_39e08499e59d1c7c0adad1cbb9f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "vote" DROP CONSTRAINT "FK_8031ceec97b8f3dd743f14198b9"`,
    );
    await queryRunner.query(
