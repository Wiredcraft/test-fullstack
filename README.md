...
* Make it responsive.
* Provide a form validation strategy (don't have to implement it if you are short on time).
* Provide an error handling strategy, such as the UI/UX, and different handling for different errors etc (don't have to implement it if you are short on time).
* Provide a complete user auth \(authentication/authorization/etc\) strategy, such as OAuth (don't have to implement it if you are short on time).
* Provide a complete logging \(when/how/etc\) strategy (don't have to implement it if you are short on time).
