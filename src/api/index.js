/**
 * Auto-generated files of all the API methods, by AWS Amplify CLI.
 */
...
export updateVotingRecord from './updateVotingRecord'
export createVotingRecord from './createVotingRecord'
