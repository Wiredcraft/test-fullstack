...
export default class Home extends Component {
  constructor(props) {
    ...
    this.onShowMsgFromComments = this.onShowMsgFromComments.bind(this);
    this.onShowCommentsError = this.onShowCommentsError.bind(this);
  }
  ...
  onShowMsgFromComments(msg) {
    this.displayNotification(msg);
  }

  onShowCommentsError(e) {
      ...
      <div className="home">
        ...
        <div className="centerContaienr">
          <Comments
            ...
            props={{ isLoggedIn: this.state.isLoggedIn }}
            onShowMsgOnHome={(e) => this.onShowMsgFromComments(e)}
          />
        </div>
        ...
        {this.state.isLoggedIn ? (
          <div className="loginContainer">
            ...
            <div className="btLogin" onClick={this.logout}>
              LOGOUT
            </div>
          </div>
        ) : (
          <div className="loginContainer">
            <label>
              Please login to add new comments or vote for existing comments.
            </label>
            <div className="btLogin" onClick={this.displayLoginModal}>
              LOGIN
            </div>

            <label className="margin50">
              Not a member yet? Create a new account to get started.
            </label>
            <div className="btLogin" onClick={this.displayRegistratiionModal}>
              REGISTER
            </div>
          </div>
        )}
        ...
        <LoginModal
          ...
          handleClose={(e) => this.closeLoginModal(e)}
          handleSuccess={(e) => this.onLoginSuccess(e)}
        />

        <RegistrationModal
          show={this.state.showRegisterModal}
          handleClose={(e) => this.hideRegistratiionModal(e)}
          handleSuccess={(e) => this.onRegistrationSuccess(e)}
        />
      </div>
    );
  }
