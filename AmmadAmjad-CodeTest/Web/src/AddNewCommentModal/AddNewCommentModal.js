  ...
  function handlePost(e) {
    ...
    HTTP.post(
      ...
      .catch((error) => {
        ...
        handleError(msg || "Failed to add new comment. Please try again later");
      });
  }
          ...
          <div className="modal-container">
            ...
            <div className="modal-body">
              ...
              {titleWarning ? (
                <label className="warning">
                  Please enter a title for the comment
                </label>
              ) : null}
              ...
              {descWarning ? (
                <label className="warning">
                  Please enter a description for the comment
                </label>
              ) : null}
            </div>
            ...
            <div className="modal-footer">
              <div className="buttonsContainer">
                ...
                <button className="bt black" onClick={handlePost}>
                  POST
                </button>
              </div>
            </div>
