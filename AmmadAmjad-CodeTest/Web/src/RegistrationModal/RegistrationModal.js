  ...
  <h3 >REGISTER </h3>
                ...
                <div className="modal-body">
                  ...
                  <label className="fieldName">Name</label>
                    ...
                    <input ref={rePwdRef} className="filedValue" type="password"></input>
                    {
                        rePwdWarning ?
                        <label className="warning">Please enter the password again</label> : 
                        null
                    }
                ...
                <div className="modal-footer">
                    <div className="buttonsContainer">
                        ...
                        <button className="bt black" onClick={handleRegistration}>REGISTER</button>
                    </div>
                </div>
                </div>
            </div>
